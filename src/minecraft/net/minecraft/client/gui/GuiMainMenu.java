...
import com.d1m.client.hud.menu.button.GuiTexturedButton;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    {
        this.buttonList.add(new GuiTexturedButton(1, width / 2 - 249, height / 2 + 60, 100, 100, "d1m/mainmenu/single.png"));
        this.buttonList.add(new GuiTexturedButton(2, width / 2 - 149, height / 2 + 60, 100, 100, "d1m/mainmenu/multi.png"));
        this.buttonList.add(new GuiTexturedButton(3, width / 2 - 49, height / 2 + 60, 100, 100, "d1m/mainmenu/wheel.png"));
        this.buttonList.add(new GuiTexturedButton(4, width / 2 + 151, height / 2 + 60, 100, 100, "d1m/mainmenu/exit.png"));
        this.buttonList.add(new GuiTexturedButton(30, width / 2 + 51, height / 2 + 60, 100, 100, "d1m/mainmenu/Alt.png"));
