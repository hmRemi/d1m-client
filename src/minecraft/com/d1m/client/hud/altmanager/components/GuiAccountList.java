package com.d1m.client.hud.altmanager.components;
...
public class GuiAccountList extends GuiSlot {
	...
	public int getSize() {
		return D1m.instance.getAccountManager().getAccounts().size();
	}
	...
	public Account getAccount(int i) {
		return D1m.instance.getAccountManager().getAccounts().get(i);
	}
	...
	public void removeSelected() {
		if (this.selected == -1)
			return;
		D1m.instance.getAccountManager().getAccounts().remove(getAccount(this.selected));
